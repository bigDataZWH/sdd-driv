...
export const DECISION_POINTS = {
  ...
  DP_1: { id: 'DP-1', name: '提案确认', phase: 'design', description: 'proposal.md 生成后确认' },
  DP_2: { id: 'DP-2', name: '规格确认', phase: 'design', description: 'specs 生成后确认' },
  DP_3: { id: 'DP-3', name: '设计确认', phase: 'design', description: '详细设计后确认' },
  DP_4: { id: 'DP-4', name: '任务确认', phase: 'design', description: 'tasks.md 生成后确认' },
