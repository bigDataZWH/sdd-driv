...
export async function initCommand(projectPath, _platformIds, options = {}) {
    ...
    if (skillsResult.skipped > 0) {
        ...
        if (drivResult.skipped > 0)
            log(`    Driv commands: ${drivResult.skipped} already exist`);
        if (templatesResult.skipped > 0)
            log(`    Templates: ${templatesResult.skipped} already exist`);
    }
    log(`\n  Get started:`);
